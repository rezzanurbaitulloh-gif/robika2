...
export function QuestTracker() {
  ...
  return (
    <div className="pointer-events-none absolute left-3 top-12 z-20 w-56 rounded border border-emerald-800 bg-black/65 p-2">
      <p className="font-mono text-[10px] uppercase tracking-widest text-emerald-600">Quest</p>
      ...
      {quest.state === "ready_turn_in" && (
        <p className="mt-1 animate-pulse font-mono text-[10px] text-amber-300">
          Kembali ke Mira untuk melapor!
        </p>
      )}
    </div>
  );
